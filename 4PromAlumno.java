...
import java.io.*;
public class 4PromAlumno {
	public static void main(String args[]) {
		//Declaraciones
		//Definicion de los objetos para entrada de datos por el teclado
		...
		try {
			...
			System.out.println("Teclee calificacion 1:");
			datoEntrada = flujoEntrada.readLine(); 
			calif1 = Float.parseFloat(datoEntrada);
				
			System.out.println("Teclee calificacion 2:");
			datoEntrada = flujoEntrada.readLine(); 
			calif2 = Float.parseFloat(datoEntrada);
				
			System.out.println("Teclee calificacion 3:");
			datoEntrada = flujoEntrada.readLine(); 
			calif3 = Float.parseFloat(datoEntrada);
				
			System.out.println("Teclee calificacion 4:");
			datoEntrada = flujoEntrada.readLine(); 
